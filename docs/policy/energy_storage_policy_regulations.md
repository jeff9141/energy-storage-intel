...
> - `[2026-07-05/06]` 联邦议院绿党以推迟为由，要求 Reiche 到经济委员会（Wirtschaftsausschuss）就 EEG 改革延误作出说明
> - **`[2026-07-08]`** **Reiche 在联邦议院经济委员会表态：EEG 改革仍计划在 7 月内提交内阁；绿党议员 Michael Kellner 公开质疑其可信度（"此前每个时间节点都已错过"），内阁表决具体日期仍未锁定**
...
> - [Verzögerungen bei Reform: Grüne wollen Reiche in Ausschuss zitieren — onvista](https://www.onvista.de/news/2026/07-05-verzoegerungen-bei-reform-gruene-wollen-reiche-in-ausschuss-zitieren-0-10-26528812) `[2026-07]`
> - [Wirtschaftsministerium: EEG-Reform soll noch im Juli ins Kabinett — onvista](https://www.onvista.de/news/2026/07-08-wirtschaftsministerium-eeg-reform-soll-noch-im-juli-ins-kabinett-0-20-26530043) `[2026-07]`
...
| 市场 | Q1 2026 负电价小时数 | Q1 2025 同期 | 占 Q1 总交易小时占比 |
|------|---------------------|--------------|---------------------|
| 西班牙 | **397 小时**（历史新高） | 48 小时 | ~16% |
| 葡萄牙 | 222 小时 | — | — |

驱动因素：光伏装机快速增长叠加伊比利亚半岛需求相对温和（气温较北欧更温和，抑制用电负荷增长）。市场预期 Q2 因日照时长增加和光伏新增装机，负电价小时数可能进一步刷新纪录。
...
> - [Negative power prices reach all-time high on the Iberian Peninsula in Q1 — PV Magazine](https://www.pv-magazine.com/2026/04/20/negative-power-prices-all-time-high-on-the-iberian-peninsula-in-q1/) `[2026-04]`
> - [Spain records 397 hours of negative prices in Q1 — PV Magazine](https://www.pv-magazine.com/2026/06/17/spain-records-397-hours-of-negatives-prices-in-q1/) `[2026-06]`
...
> - **Q1 2026 负电价小时数同比暴增 8 倍（48→397 小时），西班牙已具备与德国相当的"配储刚需"叙事，但触发机制不同（PVPC 月度结算 vs EEG 15 分钟归零）——App 收益引擎需要按市场分别建模**：西班牙 compensación simplificada 机制下，余电按小时 PVPC 现货价结算（不像德国 EEG 在负电价时段直接归零），意味着负电价小时对西班牙用户的实际收益冲击体现为"PVPC 价格跌至负值时反送电反而倒贴钱"，而非"补偿被取消"。产品含义：① App 内 PVPC 实时电价集成模块需要将"负电价预警"作为独立通知场景（区别于普通低价充电提示），提示用户此时段反送电可能产生负收益，触发自动优先自用/电池充电策略；② 16% 的 Q1 交易小时为负值意味着西班牙光伏自消费率优化已从"锦上添花"升级为接近德国的"经济性刚需"，可复用面向德国市场开发的"负电价规避"调度逻辑框架，但结算周期参数需按 PVPC 小时结算（而非德国 15 分钟窗口）重新校准；③ 该数据可直接用于西班牙市场获客话术——"Q1 已有 16% 的时间反送电不划算，配储能让这部分电为你所用"
